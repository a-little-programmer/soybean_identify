...
from vit_diff_dca_model import get_fast_keywords, get_vit_diff_model
...
MODEL_NAME = "best_vit_diff_soybean.pth"
CLASS_INDEX_NAME = "class_indices_vit_diff.json"
...
def main():
    ...
    print("实验: ViT-B/16 + Diff Attention，训练参数与 vit_train.py 对齐")
    ...
    model = get_vit_diff_model(num_classes, pretrained=True).to(DEVICE)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for phase in ["train", "val"]:
            ...
            if phase == "val" and epoch_f1 > best_f1:
                ...
                print(f"保存当前最佳 ViT-Diff 模型: {save_path}")
