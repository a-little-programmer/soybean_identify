...
from vit_diff_dca_model import get_fast_keywords, get_vit_diff_dca_model
...
def main():
    ...
    print("实验: ViT-B/16 + Diff Attention + DCA，训练参数与 vit_train.py 对齐")
    ...
    model = get_vit_diff_dca_model(num_classes, pretrained=True).to(DEVICE)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if is_freeze and epoch == 0:
            print("开启物理冻结 (仅训练分类头、Diff 分支与 DCA 路由)...")
        ...
        for phase in ["train", "val"]:
            ...
            if phase == "val" and epoch_f1 > best_f1:
                ...
                print(f"保存当前最佳 ViT-Diff-DCA 模型: {save_path}")
