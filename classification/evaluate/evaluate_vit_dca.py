...
from vit_diff_dca_model import get_vit_dca_model  # noqa: E402
...
WEIGHT_PATH = os.path.join(CHECKPOINT_DIR, "best_vit_dca_soybean.pth")
CLASS_INDEX_PATH = os.path.join(CHECKPOINT_DIR, "class_indices_vit_dca.json")
...
def load_model(num_classes):
    print("构建 ViT-DCA 架构以加载权重...")
    model = get_vit_dca_model(num_classes, pretrained=False)
...
def evaluate():
    ...
    with torch.no_grad():
        for inputs, labels in tqdm(dataloader, desc="Evaluating vit_dca"):
